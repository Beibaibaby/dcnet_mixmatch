...
#dataset=${dataset} \
#'checkpoint_path="/home/robik/occam-networks-outputs/image_net/OccamTrainer/occam_resnet18/subset_8_supp_0/lightning_logs/version_0/checkpoints/epoch=89-step=48060.ckpt"' \
