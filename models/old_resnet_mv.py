...
def old_resnet26_rgb_rgb_rgb(num_classes, width_per_group=56):
...
def old_resnet26_rgb_gs_edge(num_classes, width_per_group=56):
    model = MultiViewResNet(BottleneckMV,
                            [2, 2, 2, 2],
                            width_per_group=width_per_group,
                            input_views=['same', 'grayscale', 'edge'],
...
def old_resnet26_edge_gs_rgb(num_classes, width_per_group=56):
    model = MultiViewResNet(BottleneckMV,
                            [2, 2, 2, 2],
                            width_per_group=width_per_group,
